...
/*Cover image*/
  ...
  .bg-image{
    ...
    background-image: linear-gradient(rgba(0,0,0,0.2),rgba(0,0,0,0.3)),url('images/interiorcover.jpeg');
...
.card-container .card:hover .card-box{
	transform:  translateY(-50px);
	box-shadow:  0 10px 40px rgba(0,0,0,0.4);
	background: linear-gradient(45deg, #b95ce4, #4f29cd);
}
.card-container .card .card-box .card-content{
	padding: 20px;
	text-align:center;
}
.card-container .card .card-box .card-content h2{
	position: absolute;
	top: -10px;
	right: 30px;
	font-size: 8em;
...
.card-container .card:hover .card-box .card-content h2{
	color: #fff;
}
.card-container .card .card-box .card-content h3{
	font-size: 1.8em;
	color: #777;
	z-index: 1;
	transition: 0.5s;
}
.card-container .card:hover .card-box .card-content h3{
	color: #fff;
}
.card-container .card .card-xox .card-content p{
	font-size: 1em;
	font-weight: 300;
	color: #777;
	z-index: 1;
...
.card-container .card:hover .card-box .card-content p{
	color: #fff;
}
.card-container .card .card-box .card-content a{
	position: relative;
...
.card-container .card:hover .card-box .card-content a{
...
.site a{
    ...
    <main class="containers">
       ...
       <h1 class="cover-heading">Interior Design Renovation</h1>
           <p class="lead">Find your designer here</p>
             <p class="lead">
