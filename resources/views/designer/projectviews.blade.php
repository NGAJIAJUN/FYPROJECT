        ...
        <div class="col-sm-4" >  
            <div class="card" > 
                <div class="card-body">
                    ...
                    <a href = "{{ route('designer.showproject', ['id' => $project->id]) }}"><img src="{{ asset('thumbnails/') }}/{{$project->thumbnail}}" class="img-fluid" width="500" height="500">
                    ...
                    <br><button class="btn btn-primary" button style="width: 100%;" >Bid now</button></div></a>
